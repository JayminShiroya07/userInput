...
import { hasMinLength, isEqualsToOtherValue, isNotEmpty } from '../../util/validation.js'
...
export default function Signup() {
  ...
  function signupAction(prevFormState, formData) {
    ...
    const terms = formData.get('trems');
    ...
    if (!isNotEmpty(password) || !hasMinLength(password, 6)) {
      errors.push('you must provide a password with atleast six character.')
    }
    ...
    if (!terms)
      errors.push('you must agree to the term and conditions.');

    if (acquisition.legeth === 0)
